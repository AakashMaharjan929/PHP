...
?>
    <div class="MyAccount" style="background-color: <?php echo $background_color_ads1;?>; color: <?php echo $text_color1;?> ">
        <a href="../router.php?route=MyBookings" style="text-decoration: none; color: <?php echo $text_color1;?>">My Bookings</a> 
        <img src="../images/MyProfile/<?php echo $arrowColor1 ?>" alt="" id="arrowProfile">
    </div>
<?php
}
?>
                ...
                <form action="../Controllers/LoginAndRegistrationController.php?action=logout" method="POST">
                    <div class="formGroupLarge" id="formGroupName">
                        <div class="formGroup">
                            ...
                            <input type="text" id="name" name="name" placeholder="Mark" required value="<?php echo ($firstName); ?>" disabled>
                        </div>
                        <div class="formGroup">
                            <label for="name">Last Name <b>*</b></label><br>
                            <input type="text" id="name" name="name" placeholder="Cole" required value="<?php echo ($lastName); ?>" disabled>
                        </div>
                    </div>
                        <div class="formGroupLarge">
                            <div class="formGroup">
                                <label for="name">Email Address <b>*</b></label><br>
                                <input type="text" id="inputLong" name="name" placeholder="markCole@gmail.com" required value="<?php echo ($email); ?>" disabled>
                            </div>
                        </div>
                        <div class="formGroupLarge">
                            <div class="formGroup">
                                <label for="name">Phone Number<b>*</b></label><br>
                                <input type="text" id="inputLong" name="name" placeholder="98*******" required value="<?php echo ($phoneNumber); ?>" disabled>
                            </div>
                        </div>
                        <div class="formGroupLarge">
                            <div class="formGroup">
                                <label for="name">User Role<b>*</b></label><br>
                                <input type="text" id="inputLong" name="name" placeholder="98*******" required value="<?php echo ($role); ?>" disabled>
                            </div>
                        </div>
